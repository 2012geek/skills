...
const fs = require('fs');
// Resolve simple-git from the package root's node_modules.
// __dirname is <pkg-root>/lib/gitcode-sdk, so two levels up is the pkg root
// where node_modules lives (both in source checkout and installed plugin cache).
const PKG_ROOT = path.resolve(__dirname, '..', '..');
const simpleGit = require(path.join(PKG_ROOT, 'node_modules', 'simple-git'));
const os = require('os');
