 ...
 *
 * 用法：
 *   node skills/vlafactory-code-review/scripts/generate-pr-description.js <prNumber>
 *
 * 示例：
 *   node skills/vlafactory-code-review/scripts/generate-pr-description.js 50
 */
...
async function main() {
  ...
  try {
    ...
    rl.question('按 Enter 继续，或粘贴 AI 生成的描述（然后按 Ctrl+D）...\n', () => {
      ...
      console.log('');
      console.log(`  node skills/vlafactory-code-review/scripts/update-pr.js ${prNumber} <description-file.md>`);
      console.log('');
